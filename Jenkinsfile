    ...
    stages{
        stage ("Deploy to Unix"){
            when {
			 ...
			 sh "ssh -i /var/lib/jenkins/.ssh/id_rsa srvamr-sfaops@amer@emaaelp00020784'sudo chown srvamr-palign@amer.pfizer.com:unix-palign-u@amer.pfizer.com ${unix_deploy_path_scripts3}/*'"
			 ...
			 sh "ssh -i /var/lib/jenkins/.ssh/id_rsa srvamr-sfaops@amer@emaaelp00020784'sudo chown srvamr-palign@amer.pfizer.com:unix-palign-u@amer.pfizer.com ${unix_deploy_path_scripts4}/*'"
